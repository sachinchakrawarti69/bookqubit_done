...
const ComicsDetailsPage = () => {
  ...
  const comic = useMemo(() => {
    if (!id || !ComicsData.length) return null;
    return ComicsData.find((c) => c.id === parseInt(id));
  }, [id, ComicsData]);
    ...
    return (
      ...
      >
        <div className="text-center">
          ...
          >
            {t("comic.not_found_message") || "The comic you're looking for doesn't exist."}
          </p>
          <Link
            href="/comicslist"
  ...
  const renderStars = (rating) => {
    ...
    return (
      <div className="flex items-center">
        ...
        <span
          className={`text-lg ${theme.textColors?.highlight || "text-sky-600 dark:text-sky-400"} ml-2 font-semibold`}
        >
          {rating}/10
        </span>
      </div>
    ...
    switch (activeTab) {
      case "overview":
        return (
          <div className="space-y-6">
            <div>
              <h3
                className={`text-xl font-bold ${theme.textColors?.primary || (isDarkMode ? "text-white" : "text-gray-900")} mb-3`}
              >
                {t("comic.story_overview") || "Story Overview"}
              </h3>
              <p
                className={`text-lg leading-relaxed ${theme.textColors?.secondary || (isDarkMode ? "text-gray-400" : "text-gray-600")}`}
              >
                {comic.description}
              </p>
            </div>
            ...
            {comic.funFact && (
              <div
                className={`p-6 ${theme.background?.navigationDots || (isDarkMode ? "bg-gray-800" : "bg-gray-100")} ${theme.border?.default || "border border-gray-200 dark:border-gray-700"} rounded-xl`}
              >
                <h4
                  className={`text-lg font-bold ${theme.textColors?.highlight || "text-sky-600 dark:text-sky-400"} mb-2`}
                >
      ...
      case "characters":
        return (
          <div className="space-y-6">
            <h3
              className={`text-xl font-bold ${theme.textColors?.primary || (isDarkMode ? "text-white" : "text-gray-900")} mb-4`}
            >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {comic.charactersIntroduced?.map((character, index) => (
                ...
                >
                  <h4
                    className={`font-semibold ${theme.textColors?.primary || (isDarkMode ? "text-white" : "text-gray-900")} mb-2`}
                  >
                    {character}
                  </h4>
                  <p
                  ...
                  >
                    {t("comic.first_appearance") || "First appearance in"} {comic.title}. {t("comic.character_description") || "This character went on to become a key figure in the Marvel Universe."}
                  </p>
                </div>
              ))}
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              {comic.creators?.editor && (
                <div>
                  <h4
                    className={`font-semibold ${theme.textColors?.highlight || "text-sky-600 dark:text-sky-400"} mb-2`}
                  >
              ...
              <div>
                <h4
                  className={`font-semibold ${theme.textColors?.highlight || "text-sky-600 dark:text-sky-400"} mb-3`}
                >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {comic.creators?.writersArtists?.map((creator, index) => (
                    ...
                    >
                      <p
                        className={`font-medium ${theme.textColors?.primary || (isDarkMode ? "text-white" : "text-gray-900")}`}
                      >
                        {creator}
                      </p>
                    </div>
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div
                className={`p-6 ${theme.border?.default || "border border-gray-200 dark:border-gray-700"} ${theme.shadow?.container || "shadow-lg"} ${theme.background?.section || (isDarkMode ? "bg-gray-800" : "bg-white")} rounded-xl`}
              >
                <h4
                  className={`font-semibold ${theme.textColors?.highlight || "text-sky-600 dark:text-sky-400"} mb-3`}
                >
                  ...
                  {comic.sales?.firstPrint && (
                    <div>
                      <p
                        className={`text-sm ${theme.textColors?.secondary || (isDarkMode ? "text-gray-400" : "text-gray-600")}`}
                      >
                        {t("comic.first_print_run") || "First Print Run"}
                      </p>
                      <p
                        className={`text-lg font-semibold ${theme.textColors?.primary || (isDarkMode ? "text-white" : "text-gray-900")}`}
                      >
                        {comic.sales.firstPrint}
                      </p>
                    </div>
                  ...
                  {comic.sales?.secondPrint && (
                    <div>
                      <p
                        className={`text-sm ${theme.textColors?.secondary || (isDarkMode ? "text-gray-400" : "text-gray-600")}`}
                      >
                        {t("comic.second_print") || "Second Print"}
                      </p>
                      <p
                        className={`text-lg font-semibold ${theme.textColors?.primary || (isDarkMode ? "text-white" : "text-gray-900")}`}
                      >
            ...
            <div
              className={`p-6 ${theme.border?.default || "border border-gray-200 dark:border-gray-700"} ${theme.shadow?.container || "shadow-lg"} ${isDarkMode ? "bg-amber-900/20" : "bg-amber-50"} rounded-xl`}
            >
              <h4
                className={`font-semibold ${theme.textColors?.highlight || "text-sky-600 dark:text-sky-400"} mb-3`}
              >
                💎 {t("comic.investment_potential") || "Investment Potential"}
              </h4>
              <p
                className={`text-lg leading-relaxed ${theme.textColors?.secondary || (isDarkMode ? "text-gray-400" : "text-gray-600")}`}
              >
                {t("comic.investment_description") || "This issue is considered a key investment piece due to its historical significance as the first appearance of multiple iconic characters. Values have shown consistent appreciation over decades, making it a cornerstone of any serious comic collection."}
              </p>
            </div>
          </div>
        );
        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
            ...
            <div className="lg:col-span-1">
              <div
                className={`${theme.background?.bookCoverSide || "bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-800"} ${theme.border?.default || "border border-gray-200 dark:border-gray-700"} ${theme.shadow?.book || "shadow-2xl"} p-8 rounded-xl`}
              >
                <img
                  src={comic.image}
                  alt={comic.title}
            ...
            <div className="lg:col-span-2">
              ...
              <div className="mb-6">
                <div className="flex flex-wrap items-start justify-between gap-4 mb-4">
                  <div>
                    <h1
                      className={`text-4xl lg:text-5xl font-bold ${theme.textColors?.primary || (isDarkMode ? "text-white" : "text-gray-900")} mb-2`}
                    >
                      {comic.title}
                    </h1>
                    <p
                      className={`text-xl ${theme.textColors?.secondary || (isDarkMode ? "text-gray-400" : "text-gray-600")} mb-3`}
                    >
                      {t("comic.published_by") || "Published by"}{" "}
                  ...
                  <div className="text-right">
                    ...
                    <p
                      className={`text-sm ${theme.textColors?.secondary || (isDarkMode ? "text-gray-400" : "text-gray-600")} mt-1`}
                    >
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  <span
                    className={`px-4 py-2 ${theme.border?.default || "border border-gray-200 dark:border-gray-700"} ${theme.textColors?.badge || "text-sky-800 dark:text-sky-400"} ${isDarkMode ? "bg-sky-900/30" : "bg-sky-100"} font-semibold rounded-full`}
                  >
                    {comic.category} {t("comic.era") || "Era"}
                  </span>
                  {comic.valueToday && (
                    <span
                      className={`px-4 py-2 ${theme.border?.default || "border border-gray-200 dark:border-gray-700"} ${theme.textColors?.highlight || "text-sky-600 dark:text-sky-400"} ${isDarkMode ? "bg-amber-900/30" : "bg-amber-100"} font-bold rounded-full`}
                    >
                      {comic.valueToday}
                    </span>
                  )}
              ...
              <div className="mb-8">
                <div
                  className={`flex flex-wrap gap-2 border-b ${isDarkMode ? "border-gray-700" : "border-gray-200"} pb-2`}
                >
          ...
          >
            ...
            >
              {t("comic.related_comics") || "Related Comics"}
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {ComicsData.filter(
                ...
                .map((relatedComic) => (
                  <Link
                    key={relatedComic.id}
                    href={`/comicslist/${relatedComic.id}`}
                  ...
                  >
                    <div
                      className={`h-48 ${theme.background?.bookCoverSide || "bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-800"} flex items-center justify-center p-4`}
                    >
                      <img
                    ...
                    <div className="p-4">
                      <h3
                        className={`font-bold ${theme.textColors?.primary || (isDarkMode ? "text-white" : "text-gray-900")} mb-2 line-clamp-2`}
                      >
                        {relatedComic.title}
                      </h3>
                      <p
