  ...
  const footerLinks = [
    {
      ...
      subtitle: t("explorepage.explore_library.subtitle") || "Discover new reads",
      icon: <span className={theme.textColors?.highlight || 'text-sky-600'}>📚</span>,
      links: [
        { name: t("explorepage.explore_library.featured_books") || "Featured Books", href: "/books/featured", icon: <span className="text-amber-400 text-sm">⭐</span> },
        { name: t("explorepage.explore_library.new_releases") || "New Releases", href: "/books/newreleases", icon: <span className="w-2 h-2 bg-emerald-400 rounded-full"></span> },
        { name: t("explorepage.explore_library.genres") || "Genres", href: "/category", icon: <span className="text-purple-400 text-sm">🏷️</span> },
        { name: t("explorepage.explore_library.collections") || "Collections", href: "/collections", icon: <span className="text-indigo-400 text-sm">📚</span> },
      ],
    ...
    },
    {
      ...
      subtitle: t("explorepage.news_blog.subtitle") || "Latest updates & articles",
      icon: <span className="text-rose-500">📰</span>,
      links: [
        { name: t("explorepage.news_blog.news") || "News", href: "/footerpages/news", icon: <span className="text-red-400 text-sm">📰</span> },
        { name: t("explorepage.news_blog.blog_articles") || "Blog Articles", href: "/footerpages/blog", icon: <span className="text-blue-400 text-sm">✍️</span> },
        { name: t("explorepage.news_blog.book_reviews") || "Book Reviews & Analysis", href: "/footerpages/bookreviews", icon: <span className="text-amber-400 text-sm">⭐</span> },
      ],
    ...
    },
    {
      ...
      icon: <span className="text-rose-500">🆘</span>,
      links: [
        { name: t("explorepage.help_support.help_center") || "Help Center", href: "/footerpages/help", icon: <span className="text-sky-400 text-sm">❓</span> },
        { name: t("explorepage.help_support.contact_support") || "Contact Support", href: "/footerpages/contact", icon: <span className="text-rose-400 text-sm">🤝</span> },
        { name: t("explorepage.help_support.faq") || "FAQ", href: "/footerpages/faq", icon: <span className="text-amber-400 text-sm">❓</span> },
      ],
      ...
      <div className={`${theme.layout?.containerWidth || 'max-w-7xl'} mx-auto px-4 sm:px-6`}>
        ...
        <div className="text-center mb-10 sm:mb-12">
          ...
          <p className={`${theme.textColors?.secondary || 'text-gray-600 dark:text-gray-400'} text-sm sm:text-base max-w-2xl mx-auto`}>
            {t("explorepage.header_subtitle") || "Explore our vast library, premium features, developer tools, and vibrant community all in one place."}
          </p>
        </div>
