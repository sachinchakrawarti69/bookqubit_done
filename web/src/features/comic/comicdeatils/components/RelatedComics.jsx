          ...
          >
            ...
            >
              <div className="relative h-64 overflow-hidden">
                ...
                />
                <div
                  className={`absolute top-2 right-2 px-2 py-1 ${isDarkMode ? "bg-black/70" : "bg-white/90"} rounded-lg text-sm font-semibold ${theme.textColors?.primary || (isDarkMode ? "text-white" : "text-gray-900")}`}
                >
                  {comic.publicationDate?.split(",")[0] ||
