        ...
        <div className="flex-1">
          ...
          <div className="flex justify-between items-start mb-3">
            ...
            <div className="flex items-center">
              <span className={`text-lg font-bold ${theme.textColors?.highlight || 'text-sky-600 dark:text-sky-400'}`}>
                {comic.rating}/10
              </span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 mb-4">
            <span className={`text-sm font-semibold ${theme.textColors?.secondary || 'text-gray-600 dark:text-gray-400'}`}>
              {comic.publisher}
            </span>
          ...
          {/* Description */}
          <p className={`text-sm ${theme.textColors?.secondary || 'text-gray-600 dark:text-gray-400'} mb-4 line-clamp-3 leading-relaxed`}>
            {comic.description}
          </p>
